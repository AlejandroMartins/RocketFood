...
<head>
    ...
    <title>Cupom de Cozinha</title>
    <style>
        @media print {

            /* Define a formatação para impressão */
            body {
...
<body>
    ...
    <button onclick="imprimirCupom()">Imprimir Cupom</button>

    <script>
        function imprimirCupom() {
            var conteudoDiv = document.getElementById("conteudoParaImprimir").innerHTML;
            var janelaImpressao = window.open('', '', 'width=300,height=400');
            janelaImpressao.document.open();
            janelaImpressao.document.write('<html><head><title>Cupom de Cozinha</title></head><body>');
